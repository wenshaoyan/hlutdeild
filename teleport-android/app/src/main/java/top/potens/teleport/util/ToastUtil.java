...
public class ToastUtil {
    ...
    public static void showShortToast(String msg) {
        if(GlobalApplication.getAppContext() != null){
            if (toast == null) {
                toast = Toast.makeText(GlobalApplication.getAppContext(), msg, Toast.LENGTH_SHORT);
            } else {
                toast.setText(msg);
            }
            ...
            toast.setGravity(Gravity.BOTTOM, 0, dip2px(GlobalApplication.getAppContext(),64));
            toast.show();
        }
    }
    /**
    ...
    public static void showLongToast(String msg) {
        if(GlobalApplication.getAppContext() != null) {
            if (toast == null) {
                toast = Toast.makeText(GlobalApplication.getAppContext(), msg, Toast.LENGTH_LONG);
            } else {
                toast.setText(msg);
            }
            toast.setGravity(Gravity.BOTTOM, 0, dip2px(GlobalApplication.getAppContext(),64));
